...
<div class="lg:mx-auto h-auto" >
    <div class="top_section container mx-auto mb-4">
      <HeaderComponent :isLink="false" @btncall="openDialog" alert="Setup your position"

        learnMorr="Learn more about setting up a position ." text="Create position" type="position"
      ...
      <table aria-label="user table" class="table-auto w-full text-left text-gray-500 dark:text-gray-400">
        <thead class="N900 bg-[#FAFBFF] border border-b[#E6E8F0] dark:bg-gray-700 dark:text-gray-400">
          <tr>
            ...
            <th scope="col" class="p-2 w-1/6 N800 normal-case H400">Position name</th>
...
const positions = ref([]);
console.log(positions.value,"before save");
...
const addPosition = () => {
  if (newPosition.title && newPosition.description) {
    const nid = positions.value.length + 1;
    const newpositions = {
      id: nid,
